...
import com.hoangpro.nhasachphuongnam.base.BaseActivity;
...
public class LoginActivity extends BaseActivity {
    ...
    public void checkLog(View view) {
        ...
        if (user != null)
            if ((user.userName).equalsIgnoreCase(edtUserName.getText().toString()) && (user.password).equals(edtPassword.getText() + "")) {
                userSession = user;
                setLog();
